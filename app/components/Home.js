...
class Home extends React.Component {
	...
	render() {
		var characterNodes = this.state.characters.map((character, index) => {
			return (
				<div key={character.characterId} className={index === 0 ? 'col-xs-6 col-sm-6 md-5 col-md-offset-1' : 'col-xs-6 col-sm-6 md-5'} >
		...
		return (
			<div className='container'>
				<h3 className='text-center'>Click on the portrait</h3>
				<div className='row'>
					{ characterNodes }
				</div>
			</div>
